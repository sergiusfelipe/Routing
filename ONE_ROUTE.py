...
class Bing(object):
    ...
    def distanceUnit(self, start, end, via=[], **kwargs):
        """ Returns travel distance in kilometers
        """
        data = self.route(start, end, via, **kwargs)
        return (data['resourceSets'][0]['resources'][0]
    ...
    def routePathOutput(self, start, end, via=[], **kwargs):
        """ Returns travel distance in kilometers
        """
        data = self.route(start, end, via, **kwargs)
        return (data['resourceSets'][0]['resources'][0]
...
#--------------------- Daqui pra cima creditos a http://github.com/omniar/pybingmaps -------------------
...
class Application:
    def __init__(self, master):
        ...
        self.sextoContainer = Frame(master,bg='black')
        ...
        self.legenda = Label(self.sextoContainer, text='         -3.731843       -38.539602', bg = 'black', fg = 'white',font=('helvetica', 7)).pack(side=LEFT,padx=5)
        
        self.consultar = Button(self.segundoContainer,text='Consultar',relief=GROOVE,font=('helvetica', 10, 'bold'))
        self.consultar["command"] = self.rota
        self.consultar.pack()
